...
#define material_ramp_2 0
#define material_ramp_3 0
#define material_ramp_4 0
...
#define outline_color_1 float4(0.0, 0.0, 0.0, 1)
#define outline_color_2 float4(0.27, 0.37, 0.45, 1)
#define outline_color_3 float4(0.03, 0.03, 0.08, 1)
#define outline_color_4 float4(0.28, 0.18, 0.13, 1)

// Rim options : 
#define use_rim
// #define use_standard
// turn off standard to use a rim thats been offset by the y normal vector, its a different look but not accurate
#define rim_thickness 1.05
#define rim_softness  80 // the higher the value the harder the rim edge is 
...
#define metal_brightness  3.0
#define metal_shadow      0.2
#define metal_spec_scale  50
#define metal_spec_shine  90
#define metal_dark_color  float4(0.61, 0.49, 0.44, 1.0)
#define metal_light_color float4(1.0, 0.98, 0.94, 1.0)
#define metal_specular    float4(1.0, 1.0, 1.0, 1.0)
#define metal_in_shadow   float4(0.90, 0.88, 0.93, 1.0)
