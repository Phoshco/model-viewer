...
const float3 albedo = float3(255,180, 150) / 255;
...
const float3 albedoSub = float3(255,210, 210) / 255;
...
#define NORMAL_MAP_FILE "Norano_Body_1_N.png"
...
#define CUSTOM_A_MAP_FILE "Norano_Body_1_AO.png"
...
const float3 customB = float3(0.5, 0.4, 0.35);
